...
ZONE_RADIUS     = 0.20      # 구역 반경
HV_DETECT_RADIUS = 0.12     # HV 감지 반경 (트리거용)

# ============================================================
# [정밀 정지 튜닝] StartZone 정지 보정 + 감속 램프
# ============================================================
STOP_LEAD_DIST = 0.10       # STOP 앞당기기
STOP_RAMP_DIST = 0.30       # 감속 램프 길이
STOP_MIN_VEL   = 0.01       # 정지 직전 최소 크리핑 속도

# ============================================================
# [정지 대기 중 "잡아두기(브레이크 흉내)" 설정 + 안전장치]
# ============================================================
HOLD_BRAKE_VEL = -0.01          # HV 트리거 대기 중 계속 보낼 속도(약한 역토크)
HOLD_MAX_MOVE_DIST = 0.01       # 안전장치: 대기 시작점 대비 1cm 이상 움직이면 0으로 풀기
...
class VehicleController(Node):
    def __init__(
        ...
        self.start_zone_points = start_zone
